	...
	private class ExampleActor extends Actor {
		...
		public void act(float delta) {
			...
			if(Gdx.input.isButtonPressed(Buttons.RIGHT)){
				...
				Vector2 inputcord = screenToLocalCoordinates(
				...
				System.out.println("inputX " + inputcord.x);
				System.out.println("actorX " + actorX);
				System.out.println("widh " + getWidth());
				if(actorX <= inputcord.x && actorX + getWidth() >= inputcord.x){
					gajm.setScreen(new LevelScreen(1));
				}
